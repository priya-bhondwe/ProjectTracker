...
const SignIn = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, setFieldError }) => {
    try {
      ...
      if (response.status === 200) {
        ...
        history("/secured/dashboard");
      } else {
        // Handle other status codes or display a generic error
  ...
  return (
    <section
      className="flex relative bg-cover bg-center"
      style={{
    ...
    >
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-lg xl:p-0 dark:bg-gray-800 dark:border-gray-700 w-[400px]">
